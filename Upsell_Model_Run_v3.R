...
Master_Filev3_1 <- read.csv("../../Post_20-12/Master_File_vThree.csv",stringsAsFactors = F)
...
# temp <- aggregate(Ray_ABS_Appt~ray_practice_id, data = raw, FUN = sum)
# Master_Filev3_1$Ray_ABS_Appt <- temp$Ray_ABS_Appt[match(Master_Filev3_1$ray_practice_id, temp$ray_practice_id)]
# 
# temp <- aggregate(Ray_Appnts~ray_practice_id, data = raw, FUN = sum)
# Master_Filev3_1$Ray_Appnts <- temp$Ray_Appnts[match(Master_Filev3_1$ray_practice_id, temp$ray_practice_id)]
# 
# temp <- aggregate(Ray_Appnt_Files~ray_practice_id, data = raw, FUN = sum)
# Master_Filev3_1$Ray_Appnt_Files <- temp$Ray_Appnt_Files[match(Master_Filev3_1$ray_practice_id, temp$ray_practice_id)]
# 
# temp <- aggregate(Ray_Imm~ray_practice_id, data = raw, FUN = sum)
# Master_Filev3_1$Ray_Imm <- temp$Ray_Imm[match(Master_Filev3_1$ray_practice_id, temp$ray_practice_id)]
# 
# temp <- aggregate(Ray_Invoices~ray_practice_id, data = raw, FUN = sum)
# Master_Filev3_1$Ray_Invoices <- temp$Ray_Invoices[match(Master_Filev3_1$ray_practice_id, temp$ray_practice_id)]
# 
# temp <- aggregate(Ray_Pay~ray_practice_id, data = raw, FUN = sum)
# Master_Filev3_1$Ray_Pay <- temp$Ray_Pay[match(Master_Filev3_1$ray_practice_id, temp$ray_practice_id)]
# 
# temp <- aggregate(Ray_PG~ray_practice_id, data = raw, FUN = sum)
# Master_Filev3_1$Ray_PG <- temp$Ray_PG[match(Master_Filev3_1$ray_practice_id, temp$ray_practice_id)]
# 
# temp <- aggregate(Ray_PF~ray_practice_id, data = raw, FUN = sum)
# Master_Filev3_1$Ray_PF <- temp$Ray_PF[match(Master_Filev3_1$ray_practice_id, temp$ray_practice_id)]
# 
# temp <- aggregate(Ray_PVS~ray_practice_id, data = raw, FUN = sum)
# Master_Filev3_1$Ray_PVS <- temp$Ray_PVS[match(Master_Filev3_1$ray_practice_id, temp$ray_practice_id)]
# 
# temp <- aggregate(Ray_Prescrip~ray_practice_id, data = raw, FUN = sum)
# Master_Filev3_1$Ray_Prescrip <- temp$Ray_Prescrip[match(Master_Filev3_1$ray_practice_id, temp$ray_practice_id)]
# 
# temp <- aggregate(Ray_Soap~ray_practice_id, data = raw, FUN = sum)
# Master_Filev3_1$Ray_Soap <- temp$Ray_Soap[match(Master_Filev3_1$ray_practice_id, temp$ray_practice_id)]

# write.csv(Master_Filev3_1, "../../Post_20-12/Master_Filev3_6.csv")
...
write.csv(Master_Filev3_1, "../../Post_20-12/Master_Filev3_1.csv")
...
write.csv(Master_Filev3_1, "../../Post_20-12/Master_Filev3_2.csv")
...
# PP$ray_doc <- paste0(PP$ray_practice_id, sep = " - ", PP$doctor_id)
# Practice_Owners$ray_doc <- paste0(Practice_Owners$ray_practice_id, sep = " - ", Practice_Owners$doctor_id )
# 
# PP$ray_doc_lookup <- Practice_Owners$ray_doc[match(PP$ray_doc, Practice_Owners$ray_doc)]
# PP <- subset(PP, !is.na(PP$ray_doc_lookup))
# 
# PP$lookup <- Master_Filev3_1$ray_practice_id[match(PP$ray_practice_id, Master_Filev3_1$ray_practice_id)]
# PP <- subset(PP, !is.na(PP$lookup))

# Practice_Owners$doc_lookup <- PP$doctor_id[match(Practice_Owners$ray_practice_id, PP$ray_practice_id)]
# Practice_Owners <- subset(Practice_Owners, !is.na(Practice_Owners$doc_lookup))


##
# Master_Filev3_1$doc_ray_lookup <- PP$ray_doc_lookup[match(Master_Filev3_1$ray_practice_id, PP$ray_practice_id)]
...
write.csv(Master_Filev3_2, "../../Post_20-12/Master_Filev3_3.csv" )
...
write.csv(Master_Filev3_5, "../../Post_20-12/Master_Filev3_4.csv")

Master_Filev3_2 <- read.csv("../../Post_20-12/Master_Filev3_2.csv", stringsAsFactors = F)
